                        ...
                        <div class="pp-main col-md-9 col-sm-9">
                            ...
                            <div class="ppm-content user-content row">
                                ...
                                <div class="uct-info col-md-9">
                                    <div class="block">
                                        <label><?php echo trans('full_name'); ?>:</label> <?php if ($profile_info->name == '') : echo 'Vui lòng cập nhật';
                                                                                            else : echo $profile_info->name;
                                                                                            endif; ?>
                                    </div>
                                    <div class="block">
                                        <label><?php echo trans('email'); ?>:</label> <?php if ($profile_info->email == '') : echo 'Vui lòng cập nhật';
                                    ...
                                    <div class="block">
                                        <label><?php echo trans('phone'); ?>:</label> <?php if ($profile_info->phone == '') : echo 'Vui lòng cập nhật';
                                                                                        else : echo $profile_info->phone;
                                                                                        endif; ?>
                                    </div>
                                    <div class="block">
                                        <label><?php echo trans('date_of_birth'); ?>:</label> <?php if ($profile_info->dob == '') : echo 'Vui lòng cập nhật';
