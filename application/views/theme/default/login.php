...
<div id="section-opt" style="padding-top: 75px;">
    <div class="container">
        <div class="row">
            <div class="<?php if ($registration_enable != '1') {
                ...
                <div class="sendus">
                    ...
                    <div id="contact-form">
                        <form class="custom-form" id="login-form" method="post" action="<?php echo base_url() . 'user/do_login'; ?>">
                            ...
                            <input type="password" name="password" id="login_password" class="form-control half-wdth-field" placeholder="Password" required>
                            <div id="email_error1"></div>
                            <input type="hidden" name="action" value="submitform">
                            <p style="float: right;"><a href="<?php echo base_url() . 'user/forget_password'; ?>"><?php echo trans('forget_password?'); ?></a></p>
                            <?php if ($recaptcha_enable == '1') : echo $this->recaptcha->create_box();
                            endif; ?>
                            <div>
                                <button type="submit" value="submit" id="submit-btn" class="btn btn-success m-t-10"> <span class="btn-label"><i class="fi ion-ios-unlocked-outline"></i></span><?php echo trans('login'); ?> </button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="sendus">
                        ...
                        <div id="contact-form">
                            ...
                            <form class="custom-form" id="signup-form" method="post" action="<?php echo base_url() . 'user/signup/do_signup'; ?>">
                                ...
                                <input type="hidden" name="action" value="submitform">
                                <div>
                                    <button type="submit" value="submit" id="submit-btn2" class="btn btn-success"> <span class="btn-label"><i class="fi ion-ios-unlocked-outline"></i></span><?php echo trans('signup'); ?> </button>
                                </div>
                            </form>
                        </div>
                    </div>
