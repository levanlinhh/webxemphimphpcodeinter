    ...
    <div class="sidebar">
        <div class="sidebar-movie most-liked">
            ...
            <ul class="post-category-list list-unstyled">
                ...
                ?>
                    <li><a href="<?php echo base_url() . 'blog/category/' . $post_category->slug; ?>"><?php echo $post_category->category; ?></a></li>
                <?php endforeach ?>
            </ul>
        </div>
            ...
            ?>
                <div class="media">
                    ...
                    <div class="media-body">
                        <h1><a href="<?php echo base_url('blog/' . $most_rated_post->slug); ?>"><?php echo $most_rated_post->post_title; ?></a></h1>
