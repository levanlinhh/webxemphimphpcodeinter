...
<div class="movie-payer p-t-15">
	...
	if (($total_video_files > 0)) :
		...
		if ($file_source == 'mp4' || $file_source == 'webm' || $file_source == 'flv' || $file_source == 'm3u8' || $file_source == 'gdrive' || $file_source == 'amazone') :
			if ($file_source == 'm3u8' || $file_source == 'flv') : ?>
		...
		<div class="col-md-12 m-b-10">
			<div class="season">
				...
				foreach ($sources as $source) :
					$i++;
				?>
					<a href="<?php echo base_url() . 'watch/' . $watch_videos->slug . '.html?key=' . $source['stream_key']; ?>" class="btn btn-sm btn-inline <?php if ($source['stream_key'] == $current_file_id) {
																																									echo 'btn-server';
																																								} else if ($current_file_id == '000000' && $i == '1') {
																																									echo 'btn-server';
																																								} else {
																																									echo 'btn-default';
																																								} ?>"><?php echo $source['label']; ?></a>
				<?php endforeach; ?>
				...
				<div class="trailer">
					<?php if ($watch_videos->trailler_youtube_source != NULL && $watch_videos->trailler_youtube_source != '') : ?>
						<a href="<?php echo $watch_videos->trailler_youtube_source; ?>" class="popup-youtube btn btn-sm btn-inline btn-info"><i class="fa fa-youtube-play"></i> <?php echo trans('trailler'); ?></a>
					<?php endif; ?>
