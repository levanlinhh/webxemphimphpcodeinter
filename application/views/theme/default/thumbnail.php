...
<div class="popup" data-toggle="popover">
        ...
        <div class="movie-img">
            ...
            <?php if ($videos['is_tvseries'] != '1') : ?>
                <div class="video_quality_movie">
                    <span class="label label-primary"><?php echo $videos['video_quality']; ?>-Vietsub</span>
                </div>
            <?php endif; ?>

            <?php if ($videos['is_tvseries'] == '1') : ?>
                <div class="video_quality_movie">
                    <span class="label label-primary">Tập <?php echo $this->common_model->get_num_episodes_by_id($videos['videos_id']) . '-Vietsub'; ?></span>
                </div>
            <?php endif; ?>
