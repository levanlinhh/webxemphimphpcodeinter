        ...
        <div class="row">
                ...
                <div class="sendus">
                    ...
                    <div id="contact-form">
                        ...
                        <form class="custom-form" id="" method="post" action="<?php echo base_url() . 'contact_process'; ?>">
                            ...
                            <input type="text" name="email" id="email" class="form-control half-wdth-field" placeholder="Email">
            ...
            <div class="col-md-6 col-xs-12">
                <address class="m-l-50 text-center">
                    ...
                    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=<?php echo $map_api ?>&callback=myMap"></script>
