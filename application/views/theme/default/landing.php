...
$landing_page_image_url         =   'uploads/' . film_config('landing_bg');
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
	...
	<style>
		#body-search{background-image:url(<?php echo ($landing_page_image_url !='') ? $landing_page_image_url : base_url('uploads/landing_page/bg.jpg'); ?>)}
		.search-box .input-search{height:56px;background:#fff;font-size:20px;padding-left:20px;padding-right:90px;box-shadow:none;color:#111;border:1px solid rgba(0,0,0,0.2);border-radius:5px;border-radius:5px 0 0 5px}
		.input-group-addon{padding: 6px 12px;font-size: 14px;font-weight: 400;line-height: 1;color: #555;text-align: center;background-color: <?php if($front_end_theme =='blue'): echo "#0088cc";elseif($front_end_theme =='orange'): echo "#ff8a00";elseif($front_end_theme =='red'): echo "#ff0000";elseif($front_end_theme =='yellow'): echo "#FDD922";elseif($front_end_theme =='purple'): echo "#6d0eb1";else: echo "#0088cc";endif; ?>;border: none;border-radius: 4px;}
		.btn-all-movie{background-color: <?php if($front_end_theme =='blue'): echo "#0088cc";elseif($front_end_theme =='orange'): echo "#ff8a00";elseif($front_end_theme =='red'): echo "#ff0000";elseif($front_end_theme =='yellow'): echo "#FDD922";elseif($front_end_theme =='purple'): echo "#6d0eb1";else: echo "#0088cc";endif; ?>;border-color: <?php if($front_end_theme =='blue'): echo "#0088c9";elseif($front_end_theme =='orange'): echo "#ff8a00";elseif($front_end_theme =='red'): echo "#ff0009";elseif($front_end_theme =='yellow'): echo "#FDD929";elseif($front_end_theme =='purple'): echo "#6d0eb9";else: echo "#0088c9";endif; ?>;}
		.btn-all-movie:hover {background-color: <?php if($front_end_theme =='blue'): echo "#0088c9";elseif($front_end_theme =='orange'): echo "#ff8a00";elseif($front_end_theme =='red'): echo "#ff0009";elseif($front_end_theme =='yellow'): echo "#FDD929";elseif($front_end_theme =='purple'): echo "#6d0eb9";else: echo "#0088c9";endif; ?>;border-color: <?php if($front_end_theme =='blue'): echo "#0088c9";elseif($front_end_theme =='orange'): echo "#ff8a00";elseif($front_end_theme =='red'): echo "#ff0009";elseif($front_end_theme =='yellow'): echo "#FDD929";elseif($front_end_theme =='purple'): echo "#6d0eb9";else: echo "#0088c9";endif; ?>;}
		.submit_btn{background-color:transparent;border:none;color:#fff;font-size:18px}
		.search_container{padding-top:150px}
		.footer_container{padding-top:150px}	
	</style>
</head>
...
<body id="body-search">
	<div id="bh-header">
		<div id="bhh-menu">
			<ul class="top-menu">
				<li class="active"><a href="<?php echo base_url(); ?>" title="<?php echo trans('site_title'); ?>"><?php echo trans('site_title'); ?></a></li>
				<li><a href="<?php echo base_url('list/phim-le'); ?>" title="<?php echo trans('movies'); ?>"><?php echo trans('movies'); ?></a></li>
				<?php
				...
				?>
					<li><a href="<?php echo base_url('list/phim-bo'); ?>" title="<?php echo trans('tv_series'); ?>"><?php echo trans('tv_series'); ?></a></li>
				<?php endif; ?>
				<?php
				...
				?>
					<li><a href="<?php echo base_url('live-tv'); ?>" title="<?php echo trans('live_tv'); ?>"><?php echo trans('tv'); ?></a></li>
				<?php endif; ?>
			</ul>
			...
			<div class="clo-md-12">
				<div style="margin-bottom: 40px;">
					<a href="<?php echo base_url(); ?>">
						<img src="<?php echo base_url(); ?>uploads/system_logo/<?php echo film_config('logo'); ?>" alt="logo">
					</a>
