                                ...
                                <div class="uc-form">
                                    <form id="profile-form" action="<?php echo base_url() . 'user/change_password/update'; ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="password" type="password" class="form-control" id="full_name" value="" placeholder="Nhập mật khẩu cũ" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="new_password" type="password" class="form-control" id="full_name" value="" placeholder="Nhập mật khẩu mới" required>
                                                <span id="error-full_name" class="help-block error-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="retype_new_password" type="password" class="form-control" id="full_name" value="" placeholder="Nhập lại mật khẩu" required>
