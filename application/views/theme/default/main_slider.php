...
$slider_fullwide        =   film_config('slider_fullwide');
$slider_height          =   film_config('slider_height') . 'px';
$slider_border_radius   =   film_config('slider_border_radius') . 'px';
$slider_arrow           =   film_config('slider_arrow');
$slider_bullet          =   film_config('slider_bullet');
$total_movie_in_slider  =   film_config('total_movie_in_slider');
?>
<?php if ($slider_type == "movie" || $slider_type == "image" || $slider_type == "tv") : ?>
    ...
    <div class="inner-banner-section banner-section bg-overlay-black <?php echo (film_config('bg_img_disable') == '1') ? '' : 'bg_img'; ?>">
                ...
                <div class="swiper-wrapper">
                                        ...
                                        <div class="block">
                                            ...
                                            <?php if ($videos->genre != '' && $videos->genre != NULL) :
                                                ...
                                                foreach ($genres as $genre_id) :
                                                    ...
                                                    $i++; ?><?php echo $this->genre_model->get_genre_name_by_id($genre_id); ?>
                                    <?php endforeach;
                                            endif; ?>
                                        </div>
                    ...
                    elseif ($slider_type == "tv") :
                        ...
                        foreach ($latset_tvs as $slider) :
                            $action_url = base_url('live-tv/' . $slider->slug);
                        ?>
