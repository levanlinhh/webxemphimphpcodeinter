                ...
                <div class="panel report-panel panel-color panel-primary">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label pt-1"><?php echo trans('name'); ?></label>
                            <div class="col-sm-9">
                                <input name="name" type="text" class="form-control" rows="4" placeholder="Your Name" value="<?php if ($this->session->userdata('name')) {
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label pt-1"><?php echo trans('email'); ?></label>
                            <div class="col-sm-9">
                                <input name="email" type="email" class="form-control" rows="4" placeholder="Your Email" value="<?php if ($this->session->userdata('email')) {
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label pt-1"><?php echo trans('movie_name'); ?></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label pt-1"><?php echo trans('message'); ?></label>
                            <div class="col-sm-9">
