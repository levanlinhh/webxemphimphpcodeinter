...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/plugins/toastr.css">
...
<body>
    ...
    <section class="login-content">
        <div class="logo">
            <img src="<?php echo base_url(); ?>assets/images/logo.png" height="40">
        </div>
        <div class="login-box">
            ...
            <form class="forget-form" method="post" action="<?php echo base_url() . 'user/forget_password/do_reset' ?>">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="email" value="<?php if (isset($email)) {
                                                                                    echo $email;
                                                                                } ?>" placeholder="Email">
                </div>
                <div class="form-group btn-container">
