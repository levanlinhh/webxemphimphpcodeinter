...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        <li class="treeview <?php if ($active_menu == 6 || $active_menu == 8 || $active_menu == 9) {
                                echo " is-expanded ";
                            } ?>">
            <a href="#" class="app-menu__item" data-toggle="treeview">
                <i class="app-menu__icon fa fa-video-camera" aria-hidden="true"></i>
                <span class="app-menu__label"><?php echo trans('movies') ?></span>
        ...
        <li class="treeview <?php if ($active_menu == 28 || $active_menu == 29 || $active_menu == 30) {
                                echo " is-expanded ";
                            } ?>">
            <a href="#" class="app-menu__item" data-toggle="treeview">
        ...
        <li class="treeview <?php if ($active_menu == 26 || $active_menu == 27 || $active_menu == 35 || $active_menu == 39) {
                                echo " is-expanded ";
                            } ?>">
            <a href="#" class="app-menu__item" data-toggle="treeview">
        ...
        <li class="treeview <?php if ($active_menu == 31 || $active_menu == 32 || $active_menu == 33) {
                                echo " is-expanded ";
                            } ?>">
        ...
        <li>
            <a class="app-menu__item <?php if ($active_menu == 4001) {
                    ...
                    class="app-menu__icon fa fa-paper-plane-o"></i><span
                    class="app-menu__label"><?php echo trans('movie_request') ?></span></a>
        </li>
        <li>
            <a class="app-menu__item <?php if ($active_menu == 4002) {
                                            echo "active";
                                        } ?>" href="<?php echo base_url() . 'admin/report_manage' ?>"><i
                    class="app-menu__icon fa fa-flag-o"></i><span
                    class="app-menu__label"><?php echo trans('report') ?></span></a>
        </li>

        <li class="treeview <?php if ($active_menu == 16 || $active_menu == 17 || $active_menu == 18 || $active_menu == 19 || $active_menu == 20 || $active_menu == 21 || $active_menu == 22 || $active_menu == 24 || $active_menu == 34 || $active_menu == 350 || $active_menu == 78 || $active_menu == 79 || $active_menu == 80 || $active_menu == 160 || $active_menu == 161 || $active_menu == 162 || $active_menu == 40) {
                                echo " is-expanded ";
                            } ?>">
            <a href="#" class="app-menu__item" data-toggle="treeview">
                <i class="app-menu__icon fa fa-gears" aria-hidden="true"></i>
            ...
            <ul class="treeview-menu">
                ...
                <li>
                    <a class="treeview-item <?php if ($active_menu == 20) {
                        ...
                        <i class="app-menu__icon fa fa-share" aria-hidden="true"></i>
                ...
                <li>
                    <a class="treeview-item <?php if ($active_menu == 79) {
                        ...
                        <i class="app-menu__icon fa fa-bullseye" aria-hidden="true"></i>
                ...
                <li>
                    <a class="treeview-item <?php if ($active_menu == 22) {
                        ...
                        <i class="app-menu__icon fa fa-feed" aria-hidden="true"></i>
                ...
                <li>
                    <a class="treeview-item <?php if ($active_menu == 24) {
                        ...
                        <i class="app-menu__icon fa fa-desktop" aria-hidden="true"></i>
        ...
        <li class="treeview <?php if ($active_menu == 36 || $active_menu == 37 || $active_menu == 370 || $active_menu == 371) {
                                echo "is-expanded";
                            } ?>"> <a href="#" class="app-menu__item" data-toggle="treeview"><i
                    class="app-menu__icon fa fa-bell" aria-hidden="true"></i><span
                    class="app-menu__label"><?php echo trans("notification"); ?></span> <i
