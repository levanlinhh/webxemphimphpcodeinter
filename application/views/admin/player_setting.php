		...
		<div class="col-md-12">
			<div class="panel panel-border panel-primary">
				...
				<div class="panel-body">
					...
					<h4 class="text-left text-white"><?php echo trans('player_watermark') ?></h4>
					<hr>
					<div class="form-group">
					...
					<h4 class="text-left text-white"><?php echo trans('player_share') ?></h4>
					<hr>
					<div class="form-group">
					...
					<h4 class="text-left text-white"><?php echo trans('player_seek_button') ?></h4>
					<hr>
					<div class="form-group">
