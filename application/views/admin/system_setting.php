<?php
$registration_enable        = film_config('purchase_code');
...
$contact_to_footer_menu     = film_config('contact_to_footer_menu');
$show_star_image            = film_config('show_star_image');
$movie_report_enable        = film_config('movie_report_enable');
$movie_report_email         = film_config('movie_report_email');
$movie_request_enable       = film_config('movie_request_enable');
$movie_request_email        = film_config('movie_request_email');
$movie_report_note          = film_config('movie_report_note');
$recaptcha_enable           = film_config('recaptcha_enable');
$recaptcha_site_key         = film_config('recaptcha_site_key');
$recaptcha_secret_key       = film_config('recaptcha_secret_key');
$az_to_primary_menu         = film_config('az_to_primary_menu');
$az_to_footer_menu          = film_config('az_to_footer_menu');
$current_timezone           = film_config('timezone');
$purchase_code              = film_config('purchase_code');
		...
		<div class="col-md-12">
			<div class="panel panel-border panel-primary">
				<div class="panel-heading">
					<h1 class="panel-title"><?php echo trans('theme_options'); ?></h1>
				</div>
				<div class="panel-body">
					<div class="form-group row">
						<label class="col-sm-3 control-label"><?php echo trans('theme'); ?></label>
						<div class="col-sm-3 ">
							<select class="form-control" name="active_theme" required>
								<?php
								$theme_path = APPPATH . "views/theme/";
								$scan       = scandir($theme_path);
								foreach ($scan as $theme_title) :
									if (is_dir($theme_path . "$theme_title") && $theme_title != "." && $theme_title != "..") :
								?>
										<option value="<?php echo $theme_title; ?>" <?php if ($active_theme == $theme_title) : echo "selected";
																					endif; ?>><?php echo $theme_title; ?></option>
								<?php endif;
								endforeach; ?>
							</select>
						</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							...
							<small>Server Time: <?php echo date('Y-m-d H:i'); ?></small>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="text" value="<?php echo film_config('site_name'); ?>" name="site_name" class="form-control" required />
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<input type="url" value="<?php echo film_config('site_url'); ?>" name="site_url" class="form-control" required />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 control-label"><?php echo trans('system_email'); ?></label>
						<div class="col-sm-9">
							<input type="email" value="<?php echo film_config('system_email'); ?>" name="system_email" class="form-control" required />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 control-label"><?php echo trans('business_address'); ?></label>
						<div class="col-sm-9">
							<input type="text" value="<?php echo film_config('business_address'); ?>" name="business_address" class="form-control" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 control-label"><?php echo trans('business_phone'); ?></label>
						<div class="col-sm-9">
							<input type="number" value="<?php echo film_config('business_phone'); ?>" name="business_phone" class="form-control" data-parsley-length="[10, 14]" />
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 control-label"><?php echo trans('contact_email'); ?></label>
						<div class="col-sm-9">
							<input type="email" value="<?php echo film_config('contact_email'); ?>" name="contact_email" class="form-control" />
						</div>
					</div>
