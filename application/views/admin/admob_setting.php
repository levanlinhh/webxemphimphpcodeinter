            ...
            <div class="panel panel-border panel-primary">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="toggle">
                            <label>
                                <input type="checkbox" name="admob_ads_enable" <?php if ($admob_ads_enable == '1') {
                                                                                    echo 'checked';
                ...
                <div class="col-sm-offset-3 col-sm-9 mt-2">
                    <button type="submit" class="btn btn-primary"><span class="btn-label mr-1"> <i class="fa fa-floppy-o"></i></span>save changes </button>
                </div>
