			...
			<div class="panel panel-border panel-primary">
				...
				<div class="panel-body">
					<div id="download_link_section">
						...
						<button type="submit" class="btn btn-primary waves-effect" id="add-download-link"> <span class="btn-label mr-1"> <i class="fa fa-plus"></i></span><?php echo trans('submit'); ?></button><br><br>
						</form>
					</div>
				</div>
			</div>
