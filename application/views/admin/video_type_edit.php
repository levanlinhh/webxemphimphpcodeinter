...
?>
	...
	<h4 class="text-center text-white"><?php echo trans('edit_video_type'); ?></h4>
	<hr>
	...
	<div class="form-group">
		...
		<div class="animated-checkbox checkbox-inline">
			<label>
				<input type="checkbox" name='primary_menu' value="1" <?php if ($row['primary_menu'] == '1') {
																			echo "checked";
	...
	<div class="form-group">
		...
		<div class="animated-checkbox checkbox-inline">
			<label>
				<input type="checkbox" name='footer_menu' value="1" <?php if ($row['footer_menu'] == '1') {
																		echo "checked";
																	} ?>><span class="label-text text-white"></span>
			</label>
		</div>
