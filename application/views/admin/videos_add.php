            ...
            <div class="panel-body">
                <div class="input-group mb-3">
                    ...
                    <div class="input-group-append" id="button-area">
                        <button class="btn btn-primary" id="import_btn" type="button" id="button-addon2"><?php echo trans('fetch'); ?></button>
                    </div>
                </div>
    ...
    <div class="col-md-6">
        <div class="card cta cta--featured p-a">
            ...
            <div class="card-block mt-2">
                ...
                <div class="form-group">
                    <div class="offset-md-9 mt-2 pull-right">
                        <button type="submit" class="btn btn-block btn-primary waves-effect"> <span class="btn-label mr-1"> <i class="fa fa-plus"></i></span><?php echo trans('create'); ?> </button>
                    </div>
                </div>
            </div>
        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (imdb_status == 'success') {
                            ...
                            $("#button-area").html('<button class="btn btn-primary" id="import_btn" type="button" id="button-addon2">FETCH</button>');
                        } else {
