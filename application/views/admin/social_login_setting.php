    	...
    	<div class="row">
    			...
    			<div class="panel panel-border panel-primary">
    				...
    				<div class="panel-body">
    					<div class="form-group">
    						<label class="control-label col-md-6"><?php echo trans('facebook_login'); ?></label>
    						<div class="col-sm-8">
    							<div class="animated-checkbox checkbox-inline">
    								<label>
    									<input type="checkbox" name='facebook_login_enable' value="1" <?php if ($this->db->get_where('config', array('title' => 'facebook_login_enable'))->row()->value == '1') {
																											echo 'checked';
																										} ?>><span class="label-text text-white"><?php echo trans('enable'); ?></span>
    								</label>
    							</div>
    						</div>
    					</div>
    					...
    					<div class="form-group">
    						<label class="col-sm-6 control-label"><?php echo trans('facebook_app_id'); ?></label>
    						<div class="col-sm-8">
    					...
    					<div class="form-group">
    						<label class="col-sm-6 control-label"><?php echo trans('facebook_app_secret'); ?></label>
    						<div class="col-sm-8">
    					...
    					<div class="form-group">
    						<label class="col-sm-6 control-label"><?php echo trans('facebook_graph_version'); ?></label>
    						<div class="col-sm-8">
    		...
    		<div class="col-md-6">
    			...
    			<div class="panel panel-border panel-primary">
    				...
    				<div class="panel-body">
    					<div class="form-group">
    						<label class="control-label col-md-6"><?php echo trans('google_login'); ?></label>
    						<div class="col-sm-8">
    							<div class="animated-checkbox checkbox-inline">
    								<label>
    					...
    					<div class="form-group">
    						<label class="col-sm-6 control-label"><?php echo trans('application_name'); ?></label>
    						<div class="col-sm-8">
    					...
    					<div class="form-group">
    						<label class="col-sm-6 control-label"><?php echo trans('client_id'); ?></label>
    						<div class="col-sm-8">
    					...
    					<div class="form-group">
    						<label class="col-sm-6 control-label"><?php echo trans('client_secret'); ?></label>
    						<div class="col-sm-8">
    					...
    					<div class="form-group">
    						<label class="col-sm-6 control-label"><?php echo trans('google_redirect_uri'); ?></label>
    						<div class="col-sm-8">
