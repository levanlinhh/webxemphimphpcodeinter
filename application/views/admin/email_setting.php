		...
		<div class="col-md-12">
			<div class="panel panel-border panel-primary">
				...
				<div class="panel-body">
					<h4 class="text-white"><?php echo trans('contact_email'); ?></h4>
					<hr>
					...
					<h4 class="text-white"><?php echo trans('outgoing_server_configuration'); ?></h4>
					<hr>
					<div class="form-group row">
			...
			<div class="panel panel-border panel-primary">
				...
				<div class="panel-body">
					<div class="form-group m-0">
						<div class="input-group col-md-6 m-0 p-0">
							...
							<span class="input-group-btn">
								<button type="submit" id="import_btn" class="btn btn-primary waves-effect waves-light"> <?php echo trans('test'); ?> </button>
							</span>
						</div>
						<div id="result"></div>
						<?php echo form_close(); ?>
