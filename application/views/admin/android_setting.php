        ...
        <div class="col-md-12">
            <div class="panel panel-border panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control m-bot15" id="app_menu" name="app_menu">
                                <option value="grid" <?php if ($app_menu == 'grid') {
                                                            echo 'selected';
                                                        } ?>><?php echo trans('grid'); ?></option>
                                <option value="vertical" <?php if ($app_menu == 'vertical') {
                                                                echo 'selected';
                                                            } ?>><?php echo trans('vertical'); ?></option>
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control m-bot15" id="app_mandatory_login" name="app_mandatory_login">
                                <option value="true" <?php if ($app_mandatory_login == 'true') {
                                                            echo 'selected';
                                                        } ?>><?php echo trans('enable'); ?></option>
                                <option value="false" <?php if ($app_mandatory_login == 'false') {
                                                            echo 'selected';
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control m-bot15" id="genre_visible" name="genre_visible">
                                <option value="true" <?php if ($genre_visible == 'true') {
                                                            echo 'selected';
                                                        } ?>><?php echo trans('yes'); ?></option>
                                <option value="false" <?php if ($genre_visible == 'false') {
                                                            echo 'selected';
                                                        } ?>><?php echo trans('no'); ?></option>
                            </select>
                            <p><small><?php echo trans('app_config_change_note'); ?></small></p>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control m-bot15" id="country_visible" name="country_visible">
                                <option value="true" <?php if ($country_visible == 'true') {
                                                            echo 'selected';
                                                        } ?>><?php echo trans('yes'); ?></option>
                                <option value="false" <?php if ($country_visible == 'false') {
                                                            echo 'selected';
                                                        } ?>><?php echo trans('no'); ?></option>
                            </select>
                            <p><small><?php echo trans('app_config_change_note'); ?></small></p>
                    ...
                    <strong class="text-white"><?php echo trans("app_updater"); ?></strong>
                    <hr>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <div class="toggle">
                                <label>
                                    <input type="checkbox" name="apk_update_is_skipable" <?php if ($is_skipable == '1') {
                                                                                                echo 'checked';
                    ...
                    <div class="col-sm-offset-3 col-sm-9 mt-2 p-0">
                        <button type="submit" class="btn btn-primary"><span class="btn-label mr-1"> <i class="fa fa-floppy-o"></i></span><?php echo trans('save_change'); ?></button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
