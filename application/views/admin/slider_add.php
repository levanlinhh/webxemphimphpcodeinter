...
<h4 class="text-center text-white">New slider Add</h4>
<hr>
...
<div class="form-group">
	...
	<div class="col-sm-12">
		...
		<p class="btn btn-sm btn-white" id="thumb_link" href="#"><span class="btn-label mr-1"> <i class="fa fa-link"></i></span>Link</p>
		<p class="btn btn-sm btn-white" id="thumb_file" href="#"><span class="btn-label mr-1"> <i class="fa fa-file-o"></i></span>File</p>
	</div>
</div>
...
<div class="form-group">
	<label class="control-label col-md-12"><?php echo trans('status'); ?></label>
	<div class="col-sm-12">
...
<div class="form-group">
	<div class="col-sm-offset-3 col-sm-9 mt-2">
		<button type="submit" class="btn btn-primary waves-effect"> <span class="btn-label mr-1"> <i class="fa fa-plus"></i></span>CREATE </button>
