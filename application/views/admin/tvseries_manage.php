	...
	<div class="col-sm-12 px-0">
		<div class="row m-0 p-0">
			<div class="col-md-3 px-0">
				<a href="<?php echo base_url() . 'admin/tvseries_add'; ?>" class="btn btn-primary waves-effect waves-light"><span class="btn-label mr-1"> <i class="fa fa-plus"></i></span><?php echo trans('add_video'); ?></a> <br>
				<br>
			</div>
			...
			<tbody>
				...
				?>
					<tr id='row_<?php echo $videos['videos_id']; ?>'>
						...
						<td class="align-middle" align="center" style="width: 7%;"><img src="<?php echo $this->common_model->get_video_thumb_url($videos['videos_id']); ?>" class="img-fluid" width="50"></td>
						<td class="align-middle" style="width: 20%;"><a target="_blank" href="<?php echo base_url() . 'watch/' . $videos['slug']; ?>"><strong><?php echo $videos['title']; ?></strong></a></td>
						<td class="align-middle"><span class="description"><?php echo $videos['description']; ?></span></td>
						...
						<td class="align-middle">
							<div class="btn-group">
								<a class="btn btn-primary" href="<?php echo base_url() . 'admin/tvseries_edit/' . $videos['videos_id']; ?>"><i class="fa fa-pencil"></i></a>
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li><a class="dropdown-item" href="<?php echo base_url() . 'admin/seasons_manage/' . $videos['videos_id']; ?>">Thêm <?php echo trans('sessions_and_episodes'); ?></a></li>
									<li><a class="dropdown-item" title="<?php echo trans('delete'); ?>" href="#" onclick="delete_row(<?php echo " 'videos' " . ',' . $videos['videos_id']; ?>)" class="delete"><?php echo trans('delete'); ?> phim</a> </li>
