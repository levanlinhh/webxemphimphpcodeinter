...
<div class="card">
	<div class="row justify-content-md-center">
		<div class="col-md-7">
			<a class="btn btn-primary waves-effect mb-20" href="<?php echo base_url('admin/seasons_manage/') . $param1; ?>"> <span class="btn-label mr-1"> <i class="fa fa-arrow-left"></i></span><?php echo trans('back_to_seasons'); ?></a>
			<a class="btn btn-primary waves-effect mb-20 pull-right" href="<?php echo base_url('watch/') . $slug; ?>" target="_blank"> <span class="btn-label mr-1"> <i class="fa fa-eye"></i></span><?php echo trans('preview'); ?></a><br><br>
		...
		<div class="col-md-12">
			<div class="panel panel-border panel-primary">
				...
				<div class="panel-body">
					...
					<input type="hidden" name="videos_id" value="<?php echo $param1; ?>">
					<table class="table table-bordered table-striped dataTable" id="video-list">
						<thead>
							<tr>
						...
						<tbody>
							...
							?>
								<tr id="row_<?php echo $video_file['episodes_id']; ?>">
									<td class="align-middle"><strong><?php echo $video_file['episodes_name']; ?></strong></td>
									<td class="align-middle"><strong><?php echo $video_file['file_source']; ?></strong></td>
									...
									<td class="align-middle"><?php echo $video_file['file_url']; ?></a></td>
									<td class="align-middle">
