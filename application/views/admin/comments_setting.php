            ...
            <div class="panel panel-border panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="control-label col-md-12"><?php echo trans('comments_method'); ?></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12"><?php echo trans('comments_approval_for_mobile_app)'); ?></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12"><?php echo trans('disqus_short_name'); ?></label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-12"><?php echo trans('facebook_appId_(_for_comment)'); ?></label>
                        <div class="col-sm-6">
