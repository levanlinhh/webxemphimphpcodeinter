...
?>
	...
	<h4 class="text-center text-white">Slider Edit</h4>
	<hr>
	...
	<div class="form-group">
		...
		<div class="col-sm-12">
			<select class="form-control m-bot15" name="action_type" id="action_type">
				<option value="movie" <?php if ($row['action_type'] == 'movie') : echo "selected";
										endif; ?>>Play Movie</option>
				<option value="tvseries" <?php if ($row['action_type'] == 'tvseries') : echo "selected";
											endif; ?>>Play TVSeries</option>
				<option value="tv" <?php if ($row['action_type'] == 'tv') : echo "selected";
									endif; ?>>Watch TV Channel</option>
				<option value="external_browser" <?php if ($row['action_type'] == 'external_browser') : echo "selected";
													endif; ?>>Open URL by External Browser</option>
				<option value="webview" <?php if ($row['action_type'] == 'webview') : echo "selected";
										endif; ?>>Open WebView URL</option>
			</select>
		</div>
	</div>

	<div class="form-group" id="movie" <?php if ($row['action_type'] != 'movie') : echo 'style="display: none;"';
										endif; ?>>
	...
	<div class="form-group" id="tvseries" <?php if ($row['action_type'] != 'tvseries') : echo 'style="display: none;"';
											endif; ?>>
	...
	<div class="form-group" id="tv" <?php if ($row['action_type'] != 'tv') : echo 'style="display: none;"';
									endif; ?>>
	...
	<div id="url" <?php if ($row['action_type'] != 'external_browser' && $row['action_type'] != 'webview') : echo 'style="display: none;"';
					endif; ?>>
		<div class="form-group">
	...
	<div class="form-group">
		<label class=" col-sm-12 control-label">Button Text</label>
		<div class="col-sm-12">
	...
	<div class="form-group">
		<label class="control-label col-md-3"><?php echo trans('status'); ?></label>
		<div class="col-sm-12">
