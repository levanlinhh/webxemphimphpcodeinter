...
<div class="card">
	<div class="row justify-content-md-center">
		<div class="col-md-6">
			<a class="btn btn-primary waves-effect mb-20" href="<?php echo base_url('admin/file_and_download/') . $video_file_info->videos_id; ?>"> <span class="btn-label mr-1"> <i class="fa fa-arrow-left"></i></span><?php echo trans('back_to_list'); ?></a>
			<br><br>
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<select class="form-control" name="source" id="selected-source">
							<option value="upload" <?php if ($video_source == 'upload' || $video_file_info->file_source == 'upload') : echo 'selected';
													endif; ?>><?php echo trans('upload'); ?></option>
							<option value="youtube" <?php if ($video_source == 'youtube' || $video_file_info->file_source == 'youtube') : echo 'selected';
													endif; ?>><?php echo trans('youtube'); ?></option>
							<option value="vimeo" <?php if ($video_source == 'vimeo' || $video_file_info->file_source == 'vimeo') : echo 'selected';
													endif; ?>><?php echo trans('video'); ?></option>
							<option value="embed" <?php if ($video_source == '') : echo 'selected';
													endif; ?>><?php echo trans('google_drive'); ?></option>
							<option value="amazone" <?php if ($video_source == 'amazone' || $video_file_info->file_source == 'amazone') : echo 'selected';
													endif; ?>><?php echo trans('amazone_s3'); ?></option>
							<option value="mp4" <?php if ($video_source == 'mp4' || $video_file_info->file_source == 'mp4') : echo 'selected';
												endif; ?>><?php echo trans('mp4_from_url'); ?></option>
							<option value="webm" <?php if ($video_source == 'webm' || $video_file_info->file_source == 'webm') : echo 'selected';
													endif; ?>><?php echo trans('webm_from_url'); ?></option>
							<option value="m3u8" <?php if ($video_source == 'm3u8' || $video_file_info->file_source == 'm3u8') : echo 'selected';
													endif; ?>><?php echo trans('m3u8_from_url'); ?></option>
							<option value="embed" <?php if ($video_source == 'embed' || $video_file_info->file_source == 'embed') : echo 'selected';
					...
					<div class="form-group" <?php if ($video_source == 'upload') : echo 'style="display:none;"';
						...
						<input type="text" name="url" id="url-input-field" class="form-control" value="<?php echo $video_file_info->file_url; ?>" placeholder="http://server-2.com/movies/titalic.mp4" <?php if ($video_source != 'upload') : echo 'required';
																																																		endif; ?>><br>
					</div>
					<div class="form-group" <?php if ($video_source != 'upload') : echo 'style="display:none;"';
					...
					<div class="form-group">
						<button class="btn btn-primary waves-effect" type="submit"> <span class="btn-label mr-1"> <i class="fa fa-plus"></i></span><?php echo trans('save_changes') ?> </button>
					</div>
					</form>
				</div>
			</div>
