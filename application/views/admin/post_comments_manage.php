					...
					?>
						<tr id='row_<?php echo $comments['post_comments_id']; ?>'>
							...
							<td class="align-middle" align="center">
								<img src="<?php echo $this->common_model->get_img('user', $comments['user_id']) . '?' . time(); ?>" class="img-circle " alt="photo" height="40">
								<strong><?php echo $this->common_model->get_name_by_id($comments['user_id']); ?></strong><br>
							</td>
							<td class="align-middle"> <?php echo $comments['comment']; ?></td>
							<td class="align-middle"><?php echo $this->common_model->get_title_by_posts_id($comments['post_id']); ?></td>
							<td class="align-middle"><?php echo $comments['comment_at']; ?></td>
							<td class="align-middle">
								<?php
								// 0-Unapproved, 1 -Approved, 2-Spam, 3-Trash
