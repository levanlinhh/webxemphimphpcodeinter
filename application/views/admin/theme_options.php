					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<select class="form-control" name="front_end_theme" required>
								...
								<option value="green" <?php if (film_config("front_end_theme") == "green") {
															echo "selected";
														} ?>>Green</option>
								...
								<option value="yellow" <?php if (film_config("front_end_theme") == "yellow") {
															echo "selected";
														} ?>>Yellow</option>
								<option value="purple" <?php if (film_config("front_end_theme") == "purple") {
															echo "selected";
														} ?>>Purple</option>
							</select>
						</div>
