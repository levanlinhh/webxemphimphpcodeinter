					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<select class="form-control" name="season_order" required>
								<option value="ASC" <?php if ($season_order == "ASC") {
														echo "selected";
													} ?>><?php echo trans('ascending'); ?></option>
								<option value="DESC" <?php if ($season_order == "DESC") {
															echo "selected";
														} ?>><?php echo trans('descending'); ?></option>
							</select>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							<select class="form-control" name="episode_order" required>
								<option value="ASC" <?php if ($episode_order == "ASC") {
														echo "selected";
													} ?>><?php echo trans('ascending'); ?></option>
								<option value="DESC" <?php if ($episode_order == "DESC") {
															echo "selected";
														} ?>><?php echo trans('descending'); ?></option>
							</select>
						</div>
