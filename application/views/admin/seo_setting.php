    	...
    	<div class="row">
    		<div class="panel panel-border panel-primary col-md-6">
    			...
    			<div class="panel-body">
    				<div class="alert alert-primary col-sm-12 col-md-offset-3">
    					<p class="text-dark"><strong><?php echo trans('note'); ?>: </strong><?php echo trans('leave_blank_if_you_not_want_to_use_any_feature'); ?></p>
    				</div>
    		...
    		<div class="panel panel-border panel-primary col-md-12">
    			...
    			<div class="panel-body">
    				...
    				<div class="col-sm-offset-3 col-sm-12 mt-2 pull-right">
