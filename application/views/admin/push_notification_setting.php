					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="animated-checkbox checkbox-inline">
								<label>
									<input type="checkbox" name='push_notification_enable' value="1" <?php if ($this->db->get_where('config', array('title' => 'push_notification_enable'))->row()->value == '1') {
																											echo 'checked';
																										} ?>><span class="label-text text-white">Enable</span>
								</label>
							</div>
						</div>
					</div>
