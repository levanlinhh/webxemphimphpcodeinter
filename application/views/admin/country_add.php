...
<h4 class="text-center text-white"><?php echo trans('new_country_add'); ?></h4>
<hr>
...
<div class="form-group">
    <label class=" col-sm-3 control-label"><?php echo trans('slug'); ?></label>
    <div class="col-sm-12">
        <input type="text" id="slug" name="name" class="form-control" required>
    </div>
</div>
