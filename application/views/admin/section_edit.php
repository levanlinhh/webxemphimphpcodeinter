...
?>
    <h4 class="text-center text-white"><?php echo trans('new_section_add'); ?></h4>
    <hr>
    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-9 mt-2">
            <button type="submit" class="btn btn-primary waves-effect"> <span class="btn-label mr-1"> <i class="fa fa-plus"></i></span><?php echo trans('update'); ?> </button>
