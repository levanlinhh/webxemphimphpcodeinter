...
class Tmdb_model extends CI_Model
{
    function __construct()
    {
        ...
        $this->tmbd_api_key   = film_config('tmbd_api_key');
        $this->tmdb           = new TMDB();
    ...
    function get_movie_info($tmdb_id = '', $lang = 'en')
    {
        ...
        if ($tmdb_id == '' || $tmdb_id == NULL) :
            $tmdb_id  = '24a10883798181479179bc3b139c1ff4';
        endif;
        ...
        if (empty($data)) {
            ...
            if (count($data) > 0 && $data['title'] != '' && $data['title'] != NULL) {
                ...
                $response['imdbid']         = $data['imdb_id'];
                $response['title']          = $data['title'];
                $response['plot']           = $data['overview'];
                $response['runtime']        = $data['runtime'] . ' phút';
