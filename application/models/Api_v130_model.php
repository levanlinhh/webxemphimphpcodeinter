...
class Api_v130_model extends CI_Model
{
    ...
    {
        $credential    =   array('user_id' => $user_id, 'videos_id' => $videos_id, 'wish_list_type' => 'fav', 'wish_list_type' => 'fav', 'create_at' => date('Y-m-d H:i'));
    ...
    function add_comments($user_id   =   '', $videos_id   =  '', $comment   =  '')
    {
        ...
        $data         =   array('user_id' => $user_id, 'video_id' => $videos_id, 'comment_type' => '1', 'replay_for' => '0', 'comment' => $comment, 'comment_at' => date('Y-m-d H:i'), 'publication' => $publication);
    ...
    function add_replay($user_id   =   '', $comments_id   =  '', $comment   =  '')
    {
        ...
        $data         =   array('user_id' => $user_id, 'video_id' => $videos_id, 'comment_type' => '2', 'replay_for' => $comments_id, 'comment' => $comment, 'comment_at' => date('Y-m-d H:i'), 'publication' => $publication);
        if ($this->db->insert('comments', $data)) :
            return $this->db->insert_id();
        else :
            return FALSE;
